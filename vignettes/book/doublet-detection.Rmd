...
This is performed using the `computeDoubletDensity()` function from `r Biocpkg("scran")`, which will:
...
We recommend interpreting the `computeDoubletDensity()` scores in the context of cluster annotation.
