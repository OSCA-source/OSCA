...
For each observed cell, an initial score is computed based on the fraction of simulated doublets in its neighborhood.
...
We recommend interpreting the these scores in the context of cluster annotation.
