...
```{r, echo=FALSE}
stopifnot(igraph::are_adjacent(pseudo.out$mst, "2", "5"))
stopifnot(igraph::are_adjacent(pseudo.out$mst, "5", "8"))
stopifnot(!igraph::are_adjacent(pseudo.out$mst, "9", "8"))
```
...
```{r, echo=FALSE}
stopifnot(igraph::are_adjacent(pseudo.out2$mst, "2", "5"))
stopifnot(!igraph::are_adjacent(pseudo.out2$mst, "5", "8"))
stopifnot(igraph::are_adjacent(pseudo.out2$mst, "9", "8"))
```
