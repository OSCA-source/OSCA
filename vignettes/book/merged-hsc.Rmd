...
```{r, echo=FALSE}
stopifnot(igraph::are_adjacent(pseudo.out$mst, "10", "4"))
stopifnot(igraph::are_adjacent(pseudo.out$mst, "7", "1"))
stopifnot(igraph::are_adjacent(pseudo.out$mst, "1", "4"))
stopifnot(!igraph::are_adjacent(pseudo.out$mst, "7", "10"))
```
...
```{r, echo=FALSE}
stopifnot(igraph::are_adjacent(pseudo.out2$mst, "10", "7"))
stopifnot(igraph::are_adjacent(pseudo.out2$mst, "7", "1"))
stopifnot(igraph::are_adjacent(pseudo.out2$mst, "1", "4"))
stopifnot(!igraph::are_adjacent(pseudo.out2$mst, "10", "4"))
```
